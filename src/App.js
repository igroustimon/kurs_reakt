...
const GET_ZP = 12000;
const GET_COURS = 8777;
const GET_TIK_MARS = 77777;
export default function App() {
  ...
  const getZp = () => setBalance(balance + GET_ZP);

  const getCours = () => setBalance(balance - GET_COURS);

  const gettiktoMars = () => setBalance(balance - GET_TIK_MARS);
  ...
  return (
    <Page>
      ...
      */}
      ...
      <Header name="Ihor Ustym BANK" onClick={HelloWorld} />
      ...
      <Menu
        ...
        config={[
          ...
          {
            name: "Купити квиток на Марс",
            onClick: gettiktoMars,
            img: "/icon/mars.svg"
          }
        ]}
      />
